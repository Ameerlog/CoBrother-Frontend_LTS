    ...
    return (
      <section className="bg-white py-10 px-8">
        <div className="max-w-[1200px] mx-auto">
          ...
          <p className="text-center text-gray-500 py-12">No ventures available yet.</p>
        </div>
      </section>
    );
  }
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
          {ventures.slice(0, 8).map((venture) => {
            ...
            return (
              <div
                key={venture.id}
                className="card-glow-hover p-5 bg-white border border-gray-200 rounded-[14px] shadow-sm cursor-pointer flex flex-col transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:border-purple-200"
