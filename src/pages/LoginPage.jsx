...
export default function LoginPage() {
  ...
  const handleGoogleLogin = () => {
    ...
    const redirectUrl = `${apiUrl}/oauth2/authorization/google`;
    console.log('[OAuth] VITE_API_URL:', apiUrl);
    console.log('[OAuth] Redirecting to:', redirectUrl);
    if (!apiUrl) {
      console.error('[OAuth] ERROR: VITE_API_URL is undefined! Check .env.development file.');
